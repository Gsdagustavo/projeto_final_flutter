...
//           final expId = await DatabaseEnumUtils().getIdByExperience(exp, txn);
//
//           final stopExpData = {
...
//           ParticipantsTable.profilePicturePath: participant.profilePicturePath,
//         };
//
