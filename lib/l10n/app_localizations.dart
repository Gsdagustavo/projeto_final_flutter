...
abstract class AppLocalizations {
  ...
  /// No description provided for @continued_on_next_page.
  ///
  /// In en, this message translates to:
  /// **'Continued on next page... {reviews} more reviews'**
  String continued_on_next_page(Object reviews);

  /// No description provided for @reviews_continued.
  ///
  /// In en, this message translates to:
  /// **'Reviews (continued)'**
  String get reviews_continued;

  /// No description provided for @no_reviews_for_this_stop.
  ///
  /// In en, this message translates to:
  /// **'No reviews for this stop yet'**
  String get no_reviews_for_this_stop;
